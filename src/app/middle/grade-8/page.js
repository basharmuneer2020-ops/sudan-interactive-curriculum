...
export default function grade8Page() {
  const subjects = [
    { id: "arabic", title: "اللغة العربية (القبس)", emoji: "📝" },
    { id: "grammar", title: "قواعد النحو", emoji: "✍️" },
    { id: "english", title: "اللغة الإنجليزية", emoji: "🔤" },
    { id: "math", title: "الرياضيات", emoji: "🔢" },
    { id: "science", title: "العلم في حياتنا", emoji: "🔬" },
    { id: "quran", title: "القرآن الكريم وعلومه", emoji: "📖" },
    { id: "fiqh", title: "الفقه والعقيدة", emoji: "🕌" },
    { id: "art", title: "التربية الفنية", emoji: "🎨" }
  ]
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="bg-gradient-to-l from-emerald-500 via-teal-600 to-emerald-700 text-white">
        <div className="max-w-5xl mx-auto px-4 py-10 text-center">
          <Link href="/middle" className="text-white/70 hover:text-white text-sm mb-4 inline-block transition-colors">
            ← المرحلة المتوسطة
          </Link>
          <h1 className="text-3xl md:text-4xl font-extrabold mb-2">الصف الثامن</h1>
          <p className="text-white/70">المرحلة المتوسطة — المواد الدراسية</p>
        </div>
      </div>
