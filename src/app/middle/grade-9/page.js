...
export default function grade9Page() {
  const subjects = [
    ...
    { id: "science", title: "العلوم الطبيعية", emoji: "🔬" },
    { id: "social", title: "الدراسات الاجتماعية", emoji: "🌍" },
    { id: "islamic", title: "التربية الإسلامية", emoji: "🕌" },
    { id: "ict", title: "تكنولوجيا المعلومات", emoji: "💻" }
  ]
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="bg-gradient-to-l from-emerald-500 via-teal-600 to-emerald-700 text-white">
        <div className="max-w-5xl mx-auto px-4 py-10 text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold mb-2">الصف التاسع</h1>
